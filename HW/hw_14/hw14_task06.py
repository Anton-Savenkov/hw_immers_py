...
Необходимо написать тесты с использованием модуля pytest и
положить в class TestEmployee.
...
last_nameвозвращается в верхнем регистре, то есть "Ivanov".
...
if __name__ == '__main__':
    pytest.main(["--no-header", '-q', "--durations=0", 'test_employee.py'])
