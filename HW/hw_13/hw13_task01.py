...
class NegativeValueError(Exception):
    def __init__(self, value, dimension):
        ...
        super().__init__(
            f"{dimension} должна быть положительной, а не {value}")
...
class Rectangle:
    ...
    def __init__(self, width, height=None):
        ...
        self._validate_positive_value(self._width, "Ширина")
        self._validate_positive_value(self._height, "Высота")
    ...
    def width(self, value):
        self._validate_positive_value(value, "Ширина")
        self._width = value
    ...
    def height(self, value):
        self._validate_positive_value(value, "Высота")
        self._height = value

    def _validate_positive_value(self, value, dimension):
        if value < 0:
            raise NegativeValueError(value, dimension)
...
#Пример использования предоставленного класса
